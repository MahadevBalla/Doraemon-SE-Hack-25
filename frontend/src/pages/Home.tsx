...
export default function DoraemonLandingPage() {
        ...
        <div className={`min-h-screen font-sans transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-800'}`}>
            ...
            <header className={`sticky top-0 z-10 py-4 px-6 md:px-12 flex justify-between items-center transition-colors duration-300 ${darkMode ? 'bg-gray-800' : 'bg-blue-50'}`}>
                <div className="flex items-center gap-2">
                    <img src={doraemon} height="50px" width="50px" />
            ...
            <section className={`py-16 md:py-24 px-6 md:px-12 animate-section ${isVisible['how-it-works'] ? 'animate-fade-in' : 'opacity-0'}`} id="how-it-works">
                <div className="max-w-6xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">How Doraemon Works</h2>
                    ...
                    <div className="relative">
                        ...
                        <div className="flex flex-col sm:flex-row items-start relative">
                            ...
                            <div className={`sm:w-1/2 sm:pl-8 ${isVisible['step-4'] ? 'animate-slide-left' : 'opacity-0'} animate-section`} id="step-4">
                                ...
                                <p className="opacity-90">As your business grows, Doraemon grows with you. Add more users, warehouses, and products without compromising performance.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className={`py-16 px-6 md:px-12 ${darkMode ? 'bg-blue-900' : 'bg-blue-600'} text-white animate-section ${isVisible['cta'] ? 'animate-fade-in' : 'opacity-0'}`} id="cta">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-lg mb-8 opacity-90">Join thousands of businesses that have streamlined their operations with Doraemon.</p>
            ...
            <section id="testimonials" className={`py-16 md:py-24 px-6 md:px-12 ${darkMode ? 'bg-gray-900' : 'bg-white'}`}>
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-lg mb-12 text-center max-w-3xl mx-auto opacity-90">Businesses of all sizes trust Doraemon for their inventory management needs.</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <p className="italic opacity-90">"Doraemon transformed how we manage inventory across our 5 locations. Real-time updates and low stock alerts have virtually eliminated stockouts."</p>
                        </div>
                        ...
                        >
                            ...
                            <p className="italic opacity-90">"As a small business owner, I needed something affordable yet powerful. Doraemon scales with my business and gives me enterprise-level tools at SMB pricing."</p>
                        </div>
                    </div>
                </div>
            </section>
